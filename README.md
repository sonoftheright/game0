...
My first steps in this project will be to systematically develop the systems to support a solid game engine as a foundation for later functional developments. I plan on such developments including an extensible behavioral simulation system that is both widely editable as well as widely variable in terms of its potential expressions in individually generated entities. Generation of such entities becomes the most interesting when individual trait variety makes overall relational interactions less than predictable and even, at times, hilariously inaccurate or just silly. This requires rote fulfillment of basic behavioral microactivities which, when stacked into behavioral maps, will generate widely variable behavior amongst differing generated entities. 
...
To see the current status of the project, check out my todo.md file. To see what's planned for the future, read farther down on the todo.md file. If you're curious as to what my current random engine architecture brainstorms are looking like, check out the architecturalbrainstorm.md file. For a guide to the files and folders within the project, read the info.txt file.

The project's current level of development is tiny compared to what I dream for it, but, given time, things will begin to take a more definitive form from the cloud of mayhem that currently stands. 